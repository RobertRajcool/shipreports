 ...
 * RankingKpiRules
 *
 * @ORM\Table(name="ranking_kpi_rules")
 * @ORM\Entity(repositoryClass="Initial\ShippingBundle\Repository\RankingKpiRulesRepository")
 */
class RankingKpiRules
{
    /**
     * @var int
     *
