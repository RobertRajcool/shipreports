...
class RankingRulesType extends AbstractType
{
    private $userId;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('elementDetailsId','entity', array(
                'required' => true,
                'class' => 'Initial\ShippingBundle\Entity\RankingElementDetails',
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Initial\ShippingBundle\Entity\RankingRules'
        ));
    }
}
